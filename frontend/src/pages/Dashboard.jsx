      ...
      {!currentProject && (
        <div className="card p-8 mb-8 text-center border-dashed border-2 border-gray-200">
          ...
          <p className="text-gray-500 text-sm mb-4">
            Tell Alexandria about your research and she'll design your library structure.
          </p>
      ...
      {currentProject && (
        <div className="grid grid-cols-3 gap-4 mb-8">
          <StatCard
            icon={BookOpen}
            label="References"
            value={recentRefs.length > 0 ? '...' : '0'}
            color="bg-alexandria-600"
          ...
          {recentRefs.length === 0 ? (
            ...
            <div className="space-y-3">
              {recentRefs.map(ref => (
                ...
                >
                  <p className="text-sm font-medium text-gray-800 group-hover:text-alexandria-600 transition-colors line-clamp-1">
                    {ref.title}
                  </p>
